  ...
  <div class="register-container">
    <form @submit.prevent="handleSubmit" class="register-form">
      <div class="form-group">
        ...
        <input type="text" id="id" v-model="form.id" required class="form-input" />
      </div>
      ...
      <div class="form-group">
        ...
        <input type="text" id="name" v-model="form.name" maxlength="8" class="form-input" />
      </div>
...
const handleSubmit = async () => {
  // 2. 유효성 검사에서 'name' 제거
  if (!form.value.id || !form.value.password || !form.value.email) {
